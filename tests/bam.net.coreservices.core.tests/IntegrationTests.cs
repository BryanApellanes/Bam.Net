...
namespace Bam.Net.CoreServices.Tests
{
    ...
    public class IntegrationTests: CommandLineTool
    {
        ...
        public void WhoAmITest()
        {
            ...
            client.InvocationExceptionThrown += (o, args) => logger.AddEntry("Invocation Exception: {0}", ((ServiceProxyInvocationRequestEventArgs)args).Exception, args.PropertiesToString());
