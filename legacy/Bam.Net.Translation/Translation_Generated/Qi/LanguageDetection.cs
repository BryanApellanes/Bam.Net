...
{
    public class LanguageDetectionController : DaoController
    {	
		public ActionResult Save(Bam.Net.Translation.LanguageDetection[] values)
		{
			try
			{
				LanguageDetectionCollection saver = new LanguageDetectionCollection();
		...
		public ActionResult Retrieve(long id)
        {
			try
			{
				object value = Bam.Net.Translation.LanguageDetection.OneWhere(c => c.KeyColumn == id).ToJsonSafe();
		...
		public ActionResult OneWhere(QiQuery query)
		{
			try
			{
				query.table = Bam.Net.Data.Dao.TableName(typeof(Bam.Net.Translation.LanguageDetection));
