...
namespace Bam.Net.CoreServices.ServiceRegistration.Data.Dao
{
	...
	public DateTime? Created
	{
		...
		[Bam.Net.Exclude]
		public static ServiceRegistryLockCollection Top(int count, QueryFilter where, string orderBy = null, SortOrder sortOrder = SortOrder.Ascending, Database database = null)
		{
			Database db = database ?? Db.For<ServiceRegistryLock>();
			QuerySet query = GetQuerySet(db);
			query.Top<ServiceRegistryLock>(count);
