...
namespace Bam.Net.CoreServices.AssemblyManagement.Data.Dao.Qi
{
    ...
    {	
		public ActionResult Save(Bam.Net.CoreServices.AssemblyManagement.Data.Dao.ProcessRuntimeDescriptor[] values)
		{
			try
			{
		...
		public ActionResult Retrieve(long id)
        {
			try
			{
				object value = Bam.Net.CoreServices.AssemblyManagement.Data.Dao.ProcessRuntimeDescriptor.OneWhere(c => c.KeyColumn == id).ToJsonSafe();
		...
		public ActionResult OneWhere(QiQuery query)
		{
			try
			{
				query.table = Bam.Net.Data.Dao.TableName(typeof(Bam.Net.CoreServices.AssemblyManagement.Data.Dao.ProcessRuntimeDescriptor));
				object value = Bam.Net.CoreServices.AssemblyManagement.Data.Dao.ProcessRuntimeDescriptor.OneWhere(query).ToJsonSafe();
				return Json(new { Success = true, Message = "", Dao = value });
			}
			catch(Exception ex)
			{
		...
		public ActionResult Where(QiQuery query)
		{
			...
			{
				query.table = Bam.Net.Data.Dao.TableName(typeof(Bam.Net.CoreServices.AssemblyManagement.Data.Dao.ProcessRuntimeDescriptor));
				object[] value = Bam.Net.CoreServices.AssemblyManagement.Data.Dao.ProcessRuntimeDescriptor.Where(query).ToJsonSafe();
				return Json(new { Success = true, Message = "", Dao = value });
			}
			catch(Exception ex)
			{
