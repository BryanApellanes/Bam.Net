...
namespace Bam.Net.Encryption.Qi
{
    ...
    {	
		public ActionResult Save(Bam.Net.Encryption.VaultKey[] values)
		{
			try
			{
		...
		public ActionResult Retrieve(long id)
        {
			try
			{
				object value = Bam.Net.Encryption.VaultKey.OneWhere(c => c.KeyColumn == id).ToJsonSafe();
		...
		public ActionResult OneWhere(QiQuery query)
		{
			try
			{
				query.table = Bam.Net.Data.Dao.TableName(typeof(Bam.Net.Encryption.VaultKey));
