...
namespace Bam.Net.Shop
{
	...
	public Promotion PromotionOfPromotionId
	{
		...
		[Bam.Net.Exclude]
		public static async Task BatchAll(int batchSize, Action<IEnumerable<ShopItemPromotion>> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				ShopItemPromotionColumns columns = new ShopItemPromotionColumns();
				var orderBy = Bam.Net.Data.Order.By<ShopItemPromotionColumns>(c => c.KeyColumn, Bam.Net.Data.SortOrder.Ascending);
		...
		[Bam.Net.Exclude]
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Action<IEnumerable<ShopItemPromotion>> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		[Bam.Net.Exclude]
		public static async Task BatchQuery(int batchSize, WhereDelegate<ShopItemPromotionColumns> where, Action<IEnumerable<ShopItemPromotion>> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				ShopItemPromotionColumns columns = new ShopItemPromotionColumns();
		...
		[Bam.Net.Exclude]
		public static ShopItemPromotionCollection Top(int count, QueryFilter where, Database database)
		{
			return Top(count, where, null, database);
		}
		/// <summary>
		...
		/// <summary>
		/// Return the count of ShopItemPromotions
		/// </summary>
