...
namespace Bam.Net.Shop
{
	...
	public ShopItem ShopItemOfShopItemId
	{
		...
		public static async Task BatchAll(int batchSize, Func<ShopShopItemCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				ShopShopItemColumns columns = new ShopShopItemColumns();
				var orderBy = Order.By<ShopShopItemColumns>(c => c.KeyColumn, SortOrder.Ascending);
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<ShopShopItemCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<ShopShopItemColumns> where, Func<ShopShopItemCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				ShopShopItemColumns columns = new ShopShopItemColumns();
