...
namespace Bam.Net.Shop
{
	...
	public Currency CurrencyOfCurrencyId
	{
		...
		public static async Task BatchAll(int batchSize, Func<CurrencyCountryCollection, Task> batchProcessor, Database database = null)
		{
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<CurrencyCountryCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<CurrencyCountryColumns> where, Func<CurrencyCountryCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				CurrencyCountryColumns columns = new CurrencyCountryColumns();
