...
namespace Bam.Net.Shop
{
	...
	[Serializable]
	[Bam.Net.Data.Table("CurrencyCountry", "Shop")]
	public partial class CurrencyCountry: Dao
	{
		...
		public CurrencyCountry(DataRow data)
			: base(data)
		{
			this.SetKeyColumnName();
			this.SetChildren();
		...
		public CurrencyCountry(Database db)
			: base(db)
		{
			this.SetKeyColumnName();
			this.SetChildren();
		...
		public CurrencyCountry(Database db, DataRow data)
			: base(db, data)
		{
			this.SetKeyColumnName();
			this.SetChildren();
	...
	public Currency CurrencyOfCurrencyId
	{
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static async Task BatchAll(int batchSize, Action<IEnumerable<CurrencyCountry>> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				CurrencyCountryColumns columns = new CurrencyCountryColumns();
				var orderBy = Bam.Net.Data.Order.By<CurrencyCountryColumns>(c => c.KeyColumn, Bam.Net.Data.SortOrder.Ascending);
		...
		/// </summary>			 
		[Bam.Net.Exclude]
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Action<IEnumerable<CurrencyCountry>> batchProcessor, Database database = null)
		{
		...
		/// </summary>	
		[Bam.Net.Exclude]
		public static async Task BatchQuery(int batchSize, WhereDelegate<CurrencyCountryColumns> where, Action<IEnumerable<CurrencyCountry>> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				CurrencyCountryColumns columns = new CurrencyCountryColumns();
				...
				while(results.Count > 0)
				{
					...
					long topId = results.Select(d => d.Property<long>(columns.KeyColumn.ToString())).ToArray().Largest();
					results = Top(batchSize, (CurrencyCountryColumns)where(columns) && columns.KeyColumn > topId, orderBy, database);
				}
			});			
		}
		...
		public static CurrencyCountry GetByUuid(string uuid, Database database = null)
		{
			return OneWhere(c => Bam.Net.Data.Query.Where("Uuid") == uuid, database);
		}

		public static CurrencyCountry GetByCuid(string cuid, Database database = null)
		{
		...
		[Bam.Net.Exclude]
		public static CurrencyCountryCollection Top(int count, QueryFilter where, Database database)
		{
			return Top(count, where, null, database);
		}
		/// <summary>
		...
		/// <summary>
		/// Return the count of CurrencyCountries
		/// </summary>
