...
namespace Bam.Net.Shop
{
	...
	public ShoppingCartCollection ShoppingCartsByShopperId
	{
		...
		public static async Task BatchAll(int batchSize, Func<ShopperCollection, Task> batchProcessor, Database database = null)
		{
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<ShopperCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<ShopperColumns> where, Func<ShopperCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				ShopperColumns columns = new ShopperColumns();
