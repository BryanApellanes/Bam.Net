...
namespace Bam.Net.Shop
{
	...
	public ShopItemPromotionCollection ShopItemPromotionsByPromotionId
	{
		...
		public static async Task BatchAll(int batchSize, Func<PromotionCollection, Task> batchProcessor, Database database = null)
		{
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<PromotionCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<PromotionColumns> where, Func<PromotionCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				PromotionColumns columns = new PromotionColumns();
