...
namespace Bam.Net.Shop
{
	...
	public Promotion PromotionOfPromotionId
	{
		...
		public static async Task BatchAll(int batchSize, Func<ShopPromotionCollection, Task> batchProcessor, Database database = null)
		{
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<ShopPromotionCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<ShopPromotionColumns> where, Func<ShopPromotionCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				ShopPromotionColumns columns = new ShopPromotionColumns();
