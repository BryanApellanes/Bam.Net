...
namespace Bam.Net.Shop
{
	...
	public ShopItemAttribute ShopItemAttributeOfShopItemAttributeId
	{
		...
		public static async Task BatchAll(int batchSize, Func<ShopItemAttributeValueCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				ShopItemAttributeValueColumns columns = new ShopItemAttributeValueColumns();
				var orderBy = Order.By<ShopItemAttributeValueColumns>(c => c.KeyColumn, SortOrder.Ascending);
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<ShopItemAttributeValueCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<ShopItemAttributeValueColumns> where, Func<ShopItemAttributeValueCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				ShopItemAttributeValueColumns columns = new ShopItemAttributeValueColumns();
