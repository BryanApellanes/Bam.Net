...
namespace Bam.Net.Shop
{
	...
	public Currency CurrencyOfCurrencyId
	{
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static async Task BatchAll(int batchSize, Action<IEnumerable<Price>> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				PriceColumns columns = new PriceColumns();
				var orderBy = Bam.Net.Data.Order.By<PriceColumns>(c => c.KeyColumn, Bam.Net.Data.SortOrder.Ascending);
		...
		/// </summary>			 
		[Bam.Net.Exclude]
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Action<IEnumerable<Price>> batchProcessor, Database database = null)
		{
		...
		/// </summary>	
		[Bam.Net.Exclude]
		public static async Task BatchQuery(int batchSize, WhereDelegate<PriceColumns> where, Action<IEnumerable<Price>> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				PriceColumns columns = new PriceColumns();
