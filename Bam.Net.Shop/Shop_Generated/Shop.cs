...
namespace Bam.Net.Shop
{
	...
	public ShopPromotionCollection ShopPromotionsByShopId
	{
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static async Task BatchAll(int batchSize, Action<IEnumerable<Shop>> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				ShopColumns columns = new ShopColumns();
				var orderBy = Bam.Net.Data.Order.By<ShopColumns>(c => c.KeyColumn, Bam.Net.Data.SortOrder.Ascending);
		...
		/// </summary>			 
		[Bam.Net.Exclude]
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Action<IEnumerable<Shop>> batchProcessor, Database database = null)
		{
		...
		/// </summary>	
		[Bam.Net.Exclude]
		public static async Task BatchQuery(int batchSize, WhereDelegate<ShopColumns> where, Action<IEnumerable<Shop>> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				ShopColumns columns = new ShopColumns();
