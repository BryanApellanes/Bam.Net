...
namespace Bam.Net.Shop
{
	...
	public Promotion PromotionOfPromotionId
	{
		...
		public static async Task BatchAll(int batchSize, Func<PromotionConditionCollection, Task> batchProcessor, Database database = null)
		{
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<PromotionConditionCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<PromotionConditionColumns> where, Func<PromotionConditionCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				PromotionConditionColumns columns = new PromotionConditionColumns();
