	...
	public ShoppingListShopItemCollection ShoppingListShopItemsByShoppingListId
	{
		...
		public static async Task BatchAll(int batchSize, Action<IEnumerable<ShoppingList>> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				...
				var orderBy = Bam.Net.Data.Order.By<ShoppingListColumns>(c => c.KeyColumn, Bam.Net.Data.SortOrder.Ascending);
		...
		[Bam.Net.Exclude]
		public static ShoppingListCollection Top(int count, QueryFilter where, Database database)
		{
			return Top(count, where, null, database);
		}
		/// <summary>
