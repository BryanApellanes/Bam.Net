...
namespace Bam.Net.Shop
{
	...
	public Promotion PromotionOfPromotionId
	{
		...
		public static async Task BatchAll(int batchSize, Action<IEnumerable<PromotionCode>> batchProcessor, Database database = null)
		{
			...
			{
				PromotionCodeColumns columns = new PromotionCodeColumns();
				var orderBy = Bam.Net.Data.Order.By<PromotionCodeColumns>(c => c.KeyColumn, Bam.Net.Data.SortOrder.Ascending);
		...
		public static PromotionCode GetByCuid(string cuid, Database database = null)
		{
		...
		[Bam.Net.Exclude]
		public static PromotionCodeCollection Top(int count, QueryFilter where, Database database)
		{
			return Top(count, where, null, database);
		}
		/// <summary>
