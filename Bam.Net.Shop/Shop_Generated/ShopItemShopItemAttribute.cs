...
namespace Bam.Net.Shop
{
	...
	public ShopItemAttribute ShopItemAttributeOfShopItemAttributeId
	{
		...
		/// </summary>
		[Bam.Net.Exclude]
		public static async Task BatchAll(int batchSize, Action<IEnumerable<ShopItemShopItemAttribute>> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				ShopItemShopItemAttributeColumns columns = new ShopItemShopItemAttributeColumns();
				var orderBy = Bam.Net.Data.Order.By<ShopItemShopItemAttributeColumns>(c => c.KeyColumn, Bam.Net.Data.SortOrder.Ascending);
		...
		/// </summary>			 
		[Bam.Net.Exclude]
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Action<IEnumerable<ShopItemShopItemAttribute>> batchProcessor, Database database = null)
		{
		...
		/// </summary>	
		[Bam.Net.Exclude]
		public static async Task BatchQuery(int batchSize, WhereDelegate<ShopItemShopItemAttributeColumns> where, Action<IEnumerable<ShopItemShopItemAttribute>> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				ShopItemShopItemAttributeColumns columns = new ShopItemShopItemAttributeColumns();
		...
		[Bam.Net.Exclude]
		public static ShopItemShopItemAttributeCollection Top(int count, QueryFilter where, Database database)
		{
			return Top(count, where, null, database);
		}
		/// <summary>
		...
		/// <summary>
		/// Return the count of ShopItemShopItemAttributes
		/// </summary>
