...
namespace Bam.Net.Automation.ContinuousIntegration.Data
{
	...
	public BuildJob BuildJobOfBuildJobId
	{
		...
		public static async Task BatchAll(int batchSize, Func<BuildResultCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				BuildResultColumns columns = new BuildResultColumns();
				var orderBy = Order.By<BuildResultColumns>(c => c.KeyColumn, SortOrder.Ascending);
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<BuildResultCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<BuildResultColumns> where, Func<BuildResultCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				BuildResultColumns columns = new BuildResultColumns();
