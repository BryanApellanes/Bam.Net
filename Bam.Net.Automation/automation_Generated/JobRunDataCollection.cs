...
namespace Bam.Net.Automation.Data
{
    ...
    { 
		...
		public JobRunDataCollection(Database db, DataTable table, Dao dao = null, string rc = null) : base(db, table, dao, rc) { }
		public JobRunDataCollection(DataTable table, Dao dao = null, string rc = null) : base(table, dao, rc) { }
		public JobRunDataCollection(Query<JobRunDataColumns, JobRunData> q, Dao dao = null, string rc = null) : base(q, dao, rc) { }
