...
namespace Bam.Net.CoreServices
{
    ...
    public class ApplicationRegistrationService : ApplicationProxyableService, IApiKeyResolver, IApiKeyProvider, IApplicationNameProvider
    {
        ...
        public ApplicationRegistrationService(DefaultDatabaseProvider dataSettings, AppConf conf, ApplicationRegistrationRepository coreRepo, ILogger logger)
        {
        ...
        protected DefaultDatabaseProvider DataSettings { get; set; }
