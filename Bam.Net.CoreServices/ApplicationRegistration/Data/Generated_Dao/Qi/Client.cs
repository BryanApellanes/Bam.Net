...
namespace Bam.Net.CoreServices.ApplicationRegistration.Data.Dao.Qi
{
    ...
    {	
		...
		public ActionResult Retrieve(long id)
        {
			try
			{
				object value = Bam.Net.CoreServices.ApplicationRegistration.Data.Dao.Client.OneWhere(c => c.KeyColumn == id).ToJsonSafe();
		...
		public ActionResult OneWhere(QiQuery query)
		{
			try
			{
				query.table = Bam.Net.Data.Dao.TableName(typeof(Bam.Net.CoreServices.ApplicationRegistration.Data.Dao.Client));
				object value = Bam.Net.CoreServices.ApplicationRegistration.Data.Dao.Client.OneWhere(query).ToJsonSafe();
				return Json(new { Success = true, Message = "", Dao = value });
			}
			catch(Exception ex)
			{
		...
		public ActionResult Where(QiQuery query)
		{
			...
			{
				query.table = Bam.Net.Data.Dao.TableName(typeof(Bam.Net.CoreServices.ApplicationRegistration.Data.Dao.Client));
				object[] value = Bam.Net.CoreServices.ApplicationRegistration.Data.Dao.Client.Where(query).ToJsonSafe();
				return Json(new { Success = true, Message = "", Dao = value });
			}
			catch(Exception ex)
			{
