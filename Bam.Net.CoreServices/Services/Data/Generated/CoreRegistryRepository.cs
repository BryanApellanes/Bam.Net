...
﻿			
			...
			AddType<Bam.Net.CoreServices.Data.ExternalEventSubscription>();﻿			
			AddType<Bam.Net.CoreServices.Data.HostName>();﻿			
			AddType<Bam.Net.CoreServices.Data.Organization>();﻿			
			AddType<Bam.Net.CoreServices.Data.ServiceProcessIdentifier>();﻿			
...
﻿		
		...
		public Bam.Net.CoreServices.Data.ExternalEventSubscription GetOneExternalEventSubscriptionWhere(WhereDelegate<ExternalEventSubscriptionColumns> where)
		{
			Type wrapperType = GetWrapperType<Bam.Net.CoreServices.Data.ExternalEventSubscription>();
			return (Bam.Net.CoreServices.Data.ExternalEventSubscription)Bam.Net.CoreServices.Data.Daos.ExternalEventSubscription.GetOneWhere(where, Database).CopyAs(wrapperType, this);
		}

		public Bam.Net.CoreServices.Data.ExternalEventSubscription OneExternalEventSubscriptionWhere(WhereDelegate<ExternalEventSubscriptionColumns> where)
        {
            Type wrapperType = GetWrapperType<Bam.Net.CoreServices.Data.ExternalEventSubscription>();
            return (Bam.Net.CoreServices.Data.ExternalEventSubscription)Bam.Net.CoreServices.Data.Daos.ExternalEventSubscription.OneWhere(where, Database).CopyAs(wrapperType, this);
        }

		public IEnumerable<Bam.Net.CoreServices.Data.ExternalEventSubscription> TopExternalEventSubscriptionsWhere(int count, WhereDelegate<ExternalEventSubscriptionColumns> where)
        {
            return Wrap<Bam.Net.CoreServices.Data.ExternalEventSubscription>(Bam.Net.CoreServices.Data.Daos.ExternalEventSubscription.Top(count, where, Database));
        }
		
        public IEnumerable<Bam.Net.CoreServices.Data.ExternalEventSubscription> ExternalEventSubscriptionsWhere(WhereDelegate<ExternalEventSubscriptionColumns> where)
        {
            return Query<Bam.Net.CoreServices.Data.ExternalEventSubscription>(where(new ExternalEventSubscriptionColumns()));
        }
	    
		public long CountExternalEventSubscriptions()
        {
            return Bam.Net.CoreServices.Data.Daos.ExternalEventSubscription.Count(Database);
        }

        public long CountExternalEventSubscriptionsWhere(WhereDelegate<ExternalEventSubscriptionColumns> where)
        {
            return Bam.Net.CoreServices.Data.Daos.ExternalEventSubscription.Count(where, Database);
        }
        
        public async Task BatchQueryExternalEventSubscriptions(int batchSize, WhereDelegate<ExternalEventSubscriptionColumns> where, Action<IEnumerable<Bam.Net.CoreServices.Data.ExternalEventSubscription>> batchProcessor)
        {
            await Bam.Net.CoreServices.Data.Daos.ExternalEventSubscription.BatchQuery(batchSize, where, (batch) =>
            {
				batchProcessor(Wrap<Bam.Net.CoreServices.Data.ExternalEventSubscription>(batch));
            }, Database);
        }

		
        public async Task BatchAllExternalEventSubscriptions(int batchSize, Action<IEnumerable<Bam.Net.CoreServices.Data.ExternalEventSubscription>> batchProcessor)
        {
            await Bam.Net.CoreServices.Data.Daos.ExternalEventSubscription.BatchAll(batchSize, (batch) =>
            {
				batchProcessor(Wrap<Bam.Net.CoreServices.Data.ExternalEventSubscription>(batch));
            }, Database);
        }﻿		
		...
		public Bam.Net.CoreServices.Data.ServiceProcessIdentifier GetOneServiceProcessIdentifierWhere(WhereDelegate<ServiceProcessIdentifierColumns> where)
		{
			Type wrapperType = GetWrapperType<Bam.Net.CoreServices.Data.ServiceProcessIdentifier>();
			return (Bam.Net.CoreServices.Data.ServiceProcessIdentifier)Bam.Net.CoreServices.Data.Daos.ServiceProcessIdentifier.GetOneWhere(where, Database).CopyAs(wrapperType, this);
		}

		public Bam.Net.CoreServices.Data.ServiceProcessIdentifier OneServiceProcessIdentifierWhere(WhereDelegate<ServiceProcessIdentifierColumns> where)
        {
            Type wrapperType = GetWrapperType<Bam.Net.CoreServices.Data.ServiceProcessIdentifier>();
            return (Bam.Net.CoreServices.Data.ServiceProcessIdentifier)Bam.Net.CoreServices.Data.Daos.ServiceProcessIdentifier.OneWhere(where, Database).CopyAs(wrapperType, this);
        }

		public IEnumerable<Bam.Net.CoreServices.Data.ServiceProcessIdentifier> TopServiceProcessIdentifiersWhere(int count, WhereDelegate<ServiceProcessIdentifierColumns> where)
        {
            return Wrap<Bam.Net.CoreServices.Data.ServiceProcessIdentifier>(Bam.Net.CoreServices.Data.Daos.ServiceProcessIdentifier.Top(count, where, Database));
        }
		
        public IEnumerable<Bam.Net.CoreServices.Data.ServiceProcessIdentifier> ServiceProcessIdentifiersWhere(WhereDelegate<ServiceProcessIdentifierColumns> where)
        {
            return Query<Bam.Net.CoreServices.Data.ServiceProcessIdentifier>(where(new ServiceProcessIdentifierColumns()));
        }
	    
		public long CountServiceProcessIdentifiers()
        {
            return Bam.Net.CoreServices.Data.Daos.ServiceProcessIdentifier.Count(Database);
        }

        public long CountServiceProcessIdentifiersWhere(WhereDelegate<ServiceProcessIdentifierColumns> where)
        {
            return Bam.Net.CoreServices.Data.Daos.ServiceProcessIdentifier.Count(where, Database);
        }
        
        public async Task BatchQueryServiceProcessIdentifiers(int batchSize, WhereDelegate<ServiceProcessIdentifierColumns> where, Action<IEnumerable<Bam.Net.CoreServices.Data.ServiceProcessIdentifier>> batchProcessor)
        {
            await Bam.Net.CoreServices.Data.Daos.ServiceProcessIdentifier.BatchQuery(batchSize, where, (batch) =>
            {
				batchProcessor(Wrap<Bam.Net.CoreServices.Data.ServiceProcessIdentifier>(batch));
            }, Database);
        }

		
        public async Task BatchAllServiceProcessIdentifiers(int batchSize, Action<IEnumerable<Bam.Net.CoreServices.Data.ServiceProcessIdentifier>> batchProcessor)
        {
            await Bam.Net.CoreServices.Data.Daos.ServiceProcessIdentifier.BatchAll(batchSize, (batch) =>
            {
				batchProcessor(Wrap<Bam.Net.CoreServices.Data.ServiceProcessIdentifier>(batch));
            }, Database);
        }﻿		
