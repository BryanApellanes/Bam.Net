...
namespace Bam.Net.CoreServices.Data.Daos
{
	...
	[Serializable]
	[Bam.Net.Data.Table("Organization", "ApplicationRegistry")]
	public partial class Organization: Dao
	{
		...
		private void SetChildren()
		{
            ...
            this.ChildCollections.Add("UserOrganization_OrganizationId", new UserOrganizationCollection(Database.GetQuery<UserOrganizationColumns, UserOrganization>((c) => c.OrganizationId == GetLongValue("Id")), this, "OrganizationId"));							
            this.ChildCollections.Add("Organization_UserOrganization_User",  new XrefDaoCollection<UserOrganization, User>(this, false));
	...
	[Bam.Net.Exclude]	
	public UserOrganizationCollection UserOrganizationsByOrganizationId
	{
		get
		{
			if (this.IsNew)
			...
			if(!this.ChildCollections.ContainsKey("UserOrganization_OrganizationId"))
			{
				SetChildren();
			}

			var c = (UserOrganizationCollection)this.ChildCollections["UserOrganization_OrganizationId"];
			if(!c.Loaded)
			{
				c.Load(Database);
			}
		...
		// Xref       
        public XrefDaoCollection<UserOrganization, User> Users
        {
            get
            {			
				if (this.IsNew)
				...
				if(!this.ChildCollections.ContainsKey("Organization_UserOrganization_User"))
				{
					SetChildren();
				}

				var xref = (XrefDaoCollection<UserOrganization, User>)this.ChildCollections["Organization_UserOrganization_User"];
				if(!xref.Loaded)
				{
					xref.Load(Database);
				}
