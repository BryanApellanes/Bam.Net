...
namespace Bam.Net.CoreServices
{
    [ApiKeyRequired]
    [Proxy("eventHubSvc")]
    public class CoreEventSourceService : ProxyableService
    {
        MetricsEventSourceService _metricsEvents;
        NotificationEventSourceService _notificationEvents;
        
        protected CoreEventSourceService()
        {
        }

        public CoreEventSourceService(
        ...
        {
            CoreEventSourceService clone = new CoreEventSourceService(Repository, DaoRepository, AppConf, _metricsEvents, _notificationEvents);
