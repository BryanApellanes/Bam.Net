...
namespace Bam.Net.CoreServices
{
    [Proxy("coreUsers")]
    [Encrypt]
    public class CoreUserManagerService: ProxyableService, IUserManager
    {
        protected CoreUserManagerService() { } // to enable auto proxy gen
        public CoreUserManagerService(IDatabaseProvider dbProvider, IUserManager wrapped, IApplicationNameProvider appNameProvider)
        {
        ...
        {
            CoreUserManagerService clone = new CoreUserManagerService(DatabaseProvider, UserManager, ApplicationNameProvider);
