...
namespace Bam.Net.CoreServices
{
    ...
    {
        public AssemblyService(DefaultDatabaseProvider dataSettings, IFileService fileService, Repo.AssemblyServiceRepository repo, IApplicationNameProvider appNameProvider)
        {
