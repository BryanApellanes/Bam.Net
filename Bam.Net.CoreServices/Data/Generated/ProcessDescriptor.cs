...
namespace Bam.Net.CoreServices.Data.Daos
{
	...
	[Serializable]
	[Bam.Net.Data.Table("ProcessDescriptor", "CoreRegistry")]
	public partial class ProcessDescriptor: Dao
	{
	...
	public Application ApplicationOfApplicationId
	{
		...
		public static ProcessDescriptorCollection LoadAll(Database database = null)
		{
			...
			var results = new ProcessDescriptorCollection(sql.GetDataTable(db));
			results.Database = db;
			return results;
		}
