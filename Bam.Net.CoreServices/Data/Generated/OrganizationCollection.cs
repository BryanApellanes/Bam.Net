...
namespace Bam.Net.CoreServices.Data.Daos
{
    ...
    { 
		...
		public OrganizationCollection(Database db, DataTable table, Dao dao = null, string rc = null) : base(db, table, dao, rc) { }
		public OrganizationCollection(DataTable table, Dao dao = null, string rc = null) : base(table, dao, rc) { }
		public OrganizationCollection(Query<OrganizationColumns, Organization> q, Dao dao = null, string rc = null) : base(q, dao, rc) { }
