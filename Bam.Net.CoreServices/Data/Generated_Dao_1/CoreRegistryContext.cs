...
namespace Bam.Net.CoreServices.Data.Dao
{
	...
	public class ConfigurationQueryContext
	{
			...
			{
				return Bam.Net.CoreServices.Data.Dao.Configuration.Where(where, db);
			}
			...
			{
				return Bam.Net.CoreServices.Data.Dao.Configuration.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<ConfigurationColumns> where, Database db = null)
			{
				return Bam.Net.CoreServices.Data.Dao.Configuration.Count(where, db);
			}
	}
	...
	public class ConfigurationSettingQueryContext
	{
			...
			{
				return Bam.Net.CoreServices.Data.Dao.ConfigurationSetting.Where(where, db);
			}
			...
			{
				return Bam.Net.CoreServices.Data.Dao.ConfigurationSetting.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<ConfigurationSettingColumns> where, Database db = null)
			{
				return Bam.Net.CoreServices.Data.Dao.ConfigurationSetting.Count(where, db);
			}
	}
	...
	public class HostAddressQueryContext
	{
			...
			{
				return Bam.Net.CoreServices.Data.Dao.HostAddress.Where(where, db);
			}
			...
			{
				return Bam.Net.CoreServices.Data.Dao.HostAddress.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<HostAddressColumns> where, Database db = null)
			{
				return Bam.Net.CoreServices.Data.Dao.HostAddress.Count(where, db);
			}
	}
	...
	public class ApplicationQueryContext
	{
			...
			{
				return Bam.Net.CoreServices.Data.Dao.Application.Where(where, db);
			}
			...
			{
				return Bam.Net.CoreServices.Data.Dao.Application.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<ApplicationColumns> where, Database db = null)
			{
				return Bam.Net.CoreServices.Data.Dao.Application.Count(where, db);
			}
	}
	...
	public class ProcessDescriptorQueryContext
	{
			...
			{
				return Bam.Net.CoreServices.Data.Dao.ProcessDescriptor.Where(where, db);
			}
			...
			{
				return Bam.Net.CoreServices.Data.Dao.ProcessDescriptor.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<ProcessDescriptorColumns> where, Database db = null)
			{
				return Bam.Net.CoreServices.Data.Dao.ProcessDescriptor.Count(where, db);
			}
	}
	...
	public class MachineQueryContext
	{
			...
			{
				return Bam.Net.CoreServices.Data.Dao.Machine.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<MachineColumns> where, Database db = null)
			{
				return Bam.Net.CoreServices.Data.Dao.Machine.Count(where, db);
			}
	}
	...
	public class ClientServerConnectionQueryContext
	{
			...
			{
				return Bam.Net.CoreServices.Data.Dao.ClientServerConnection.Where(where, db);
			}
			...
			{
				return Bam.Net.CoreServices.Data.Dao.ClientServerConnection.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<ClientServerConnectionColumns> where, Database db = null)
			{
				return Bam.Net.CoreServices.Data.Dao.ClientServerConnection.Count(where, db);
			}
	}
	...
	public class OrganizationQueryContext
	{
			...
			{
				return Bam.Net.CoreServices.Data.Dao.Organization.Where(where, db);
			}
			...
			{
				return Bam.Net.CoreServices.Data.Dao.Organization.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<OrganizationColumns> where, Database db = null)
			{
				return Bam.Net.CoreServices.Data.Dao.Organization.Count(where, db);
			}
	}
	...
	public class SubscriptionQueryContext
	{
			...
			{
				return Bam.Net.CoreServices.Data.Dao.Subscription.Where(where, db);
			}
			...
			{
				return Bam.Net.CoreServices.Data.Dao.Subscription.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<SubscriptionColumns> where, Database db = null)
			{
				return Bam.Net.CoreServices.Data.Dao.Subscription.Count(where, db);
			}
	}
	...
	public class ApplicationMachineQueryContext
	{
			...
			{
				return Bam.Net.CoreServices.Data.Dao.ApplicationMachine.Where(where, db);
			}
			...
			{
				return Bam.Net.CoreServices.Data.Dao.ApplicationMachine.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<ApplicationMachineColumns> where, Database db = null)
			{
				return Bam.Net.CoreServices.Data.Dao.ApplicationMachine.Count(where, db);
			}
	}
	...
	public class OrganizationUserQueryContext
	{
			...
			{
				return Bam.Net.CoreServices.Data.Dao.OrganizationUser.Where(where, db);
			}
			...
			{
				return Bam.Net.CoreServices.Data.Dao.OrganizationUser.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<OrganizationUserColumns> where, Database db = null)
			{
				return Bam.Net.CoreServices.Data.Dao.OrganizationUser.Count(where, db);
			}
	}
