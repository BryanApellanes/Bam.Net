...
namespace Bam.Net.CoreServices.Data.Daos
{
    ...
    { 
		...
		public ConfigurationApplicationCollection(Database db, DataTable table, Bam.Net.Data.Dao dao = null, string rc = null) : base(db, table, dao, rc) { }
		public ConfigurationApplicationCollection(DataTable table, Bam.Net.Data.Dao dao = null, string rc = null) : base(table, dao, rc) { }
		public ConfigurationApplicationCollection(Query<ConfigurationApplicationColumns, ConfigurationApplication> q, Bam.Net.Data.Dao dao = null, string rc = null) : base(q, dao, rc) { }
