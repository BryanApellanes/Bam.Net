...
namespace Bam.Net.CoreServices.Data.Dao
{
    public class MachineColumns: QueryFilter<MachineColumns>, IFilterToken
    {
        ...
        public MachineColumns ServerHost
        {
            get
            {
                return new MachineColumns("ServerHost");
            }
        }
        public MachineColumns Port
        {
            get
            {
                return new MachineColumns("Port");
            }
        }
        public MachineColumns Secret
        {
            get
            {
