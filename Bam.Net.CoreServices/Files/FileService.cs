...
namespace Bam.Net.CoreServices
{
    ...
    public class FileService : ApplicationProxyableService, IFileService
    {
        ...
        public FileService(IRepository repository, DefaultDataSettingsProvider dataSettings = null, ILogger logger = null)
        {
            ...
            DataSettings = dataSettings ?? DefaultDataSettingsProvider.Instance;
        ...
        protected DefaultDataSettingsProvider DataSettings { get; }
