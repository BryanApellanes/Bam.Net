...
namespace Bam.Net.Data.Dynamic.Tests
{
    ...
    public class DynamicRepositoryTests: CommandLineTestInterface
    {
        ...
        {
            public TestDynamicTypeManager(DynamicTypeDataRepository descriptorRepository, DefaultDataSettingsProvider settings) : base(descriptorRepository, settings)
            {
            }
        ...
        {
            TestDynamicTypeManager testRepo = new TestDynamicTypeManager(new DynamicTypeDataRepository(), DefaultDataSettingsProvider.Instance);
        ...
        public void SaveRealData()
        {
            ...
            DynamicTypeManager typeManager = new DynamicTypeManager(new DynamicTypeDataRepository(), DefaultDataSettingsProvider.Instance);
        ...
        {
            DynamicTypeManager mgr = new DynamicTypeManager(new DynamicTypeDataRepository(), DefaultDataSettingsProvider.Instance);
