...
namespace Bam.Net.Data.Integration.Tests
{
    ...
    {
        [UnitTest("SchemaExtractor: Get Table Names")]
        ...
        [UnitTest("SchemaExtractor: Get Column Names")]
        ...
        [UnitTest("SchemaExtractor: Get Column Data type")]
        ...
        [UnitTest("SchemaExtractor: Get Foreign Key Columns")]
