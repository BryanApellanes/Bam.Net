...
bam.pageActivated("imageStream", function(page){
    ...
    var slides = $("#imageSlides").data("slideShow");
    //slides.afterSlide = function(ss){
    //    alert("current slide index: " + ss.currentSlideIndex);
    //    //imageStream.getNextSet();
    //};
    imageStream.start();
});

bam.app.run("rankypanky", "imageStream");
