...
namespace Bam.Net.UserAccounts.Data.Qi
{
    ...
    {	
		public ActionResult Save(Bam.Net.UserAccounts.Data.PasswordFailure[] values)
		{
			try
			{
		...
		public ActionResult Retrieve(long id)
        {
			try
			{
				object value = Bam.Net.UserAccounts.Data.PasswordFailure.OneWhere(c => c.KeyColumn == id).ToJsonSafe();
		...
		public ActionResult OneWhere(QiQuery query)
		{
			try
			{
				query.table = Bam.Net.Data.Dao.TableName(typeof(Bam.Net.UserAccounts.Data.PasswordFailure));
