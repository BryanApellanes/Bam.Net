...
namespace Bam.Net.UserAccounts.Data
{
	...
	public partial class UserPermission: Dao
	{
	...
	public Permission PermissionOfPermissionId
	{
		...
		public static UserPermissionCollection LoadAll(Database database = null)
		{
			...
			var results = new UserPermissionCollection(sql.GetDataTable(db));
			results.Database = db;
			return results;
		}

		public static async Task BatchAll(int batchSize, Func<UserPermissionCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				UserPermissionColumns columns = new UserPermissionColumns();
				var orderBy = Order.By<UserPermissionColumns>(c => c.KeyColumn, SortOrder.Ascending);
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<UserPermissionCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<UserPermissionColumns> where, Func<UserPermissionCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				UserPermissionColumns columns = new UserPermissionColumns();
