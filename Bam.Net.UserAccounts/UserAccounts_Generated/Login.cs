...
namespace Bam.Net.UserAccounts.Data
{
	...
	public User UserOfUserId
	{
		...
		public static async Task BatchAll(int batchSize, Func<LoginCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				LoginColumns columns = new LoginColumns();
				var orderBy = Order.By<LoginColumns>(c => c.KeyColumn, SortOrder.Ascending);
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<LoginCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<LoginColumns> where, Func<LoginCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				LoginColumns columns = new LoginColumns();
