...
namespace Bam.Net.UserAccounts.Data
{
	...
	public partial class GroupPermission: Dao
	{
	...
	public Permission PermissionOfPermissionId
	{
		...
		public static GroupPermissionCollection LoadAll(Database database = null)
		{
			...
			var results = new GroupPermissionCollection(sql.GetDataTable(db));
			results.Database = db;
			return results;
		}

		public static async Task BatchAll(int batchSize, Func<GroupPermissionCollection, Task> batchProcessor, Database database = null)
		{
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<GroupPermissionCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<GroupPermissionColumns> where, Func<GroupPermissionCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				GroupPermissionColumns columns = new GroupPermissionColumns();
