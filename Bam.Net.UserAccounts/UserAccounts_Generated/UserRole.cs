...
namespace Bam.Net.UserAccounts.Data
{
	...
	public Role RoleOfRoleId
	{
		...
		public static async Task BatchAll(int batchSize, Func<UserRoleCollection, Task> batchProcessor, Database database = null)
		{
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<UserRoleCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<UserRoleColumns> where, Func<UserRoleCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				UserRoleColumns columns = new UserRoleColumns();
