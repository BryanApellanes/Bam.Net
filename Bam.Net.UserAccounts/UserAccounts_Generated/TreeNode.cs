...
namespace Bam.Net.UserAccounts.Data
{
	...
	public PermissionCollection PermissionsByTreeNodeId
	{
		...
		public static async Task BatchAll(int batchSize, Func<TreeNodeCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				TreeNodeColumns columns = new TreeNodeColumns();
				var orderBy = Order.By<TreeNodeColumns>(c => c.KeyColumn, SortOrder.Ascending);
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<TreeNodeCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<TreeNodeColumns> where, Func<TreeNodeCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				TreeNodeColumns columns = new TreeNodeColumns();
