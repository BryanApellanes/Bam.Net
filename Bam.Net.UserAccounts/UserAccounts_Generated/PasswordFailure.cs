...
namespace Bam.Net.UserAccounts.Data
{
	...
	public User UserOfUserId
	{
		...
		public static async Task BatchAll(int batchSize, Func<PasswordFailureCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				PasswordFailureColumns columns = new PasswordFailureColumns();
				var orderBy = Order.By<PasswordFailureColumns>(c => c.KeyColumn, SortOrder.Ascending);
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<PasswordFailureCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<PasswordFailureColumns> where, Func<PasswordFailureCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				PasswordFailureColumns columns = new PasswordFailureColumns();
