...
namespace Bam.Net.UserAccounts.Data
{
	...
	public User UserOfUserId
	{
		...
		public static async Task BatchAll(int batchSize, Func<SettingCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				SettingColumns columns = new SettingColumns();
				var orderBy = Order.By<SettingColumns>(c => c.KeyColumn, SortOrder.Ascending);
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<SettingCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<SettingColumns> where, Func<SettingCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				SettingColumns columns = new SettingColumns();
