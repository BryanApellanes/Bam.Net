...
{
    public class RazorEngineDaoGeneratorTests : CommandLineTestInterface
    {
        [UnitTest]
        ...
        public static void RazorParseTableWithKeyColumn()
        {
            ...
            string result = razorParser.ExecuteResource("Class.tmpl", SchemaTemplateResources.Path, typeof(DaoGenerator).Assembly, new { Model = value, Schema = schema, Namespace = "Monkey.balls" });
