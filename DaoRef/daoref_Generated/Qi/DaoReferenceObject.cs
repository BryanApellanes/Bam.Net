...
namespace Qi
{
    ...
    {	
		...
		public ActionResult Create(Bam.Net.DaoRef.DaoReferenceObject dao)
		{
			return Update(dao);
		}
		...
		public ActionResult Retrieve(long id)
        {
			try
			{
				object value = Bam.Net.DaoRef.DaoReferenceObject.OneWhere(c => c.KeyColumn == id).ToJsonSafe();
		...
		public ActionResult Update(Bam.Net.DaoRef.DaoReferenceObject dao)
        {
			try
			{
				dao.Save();
		...
		public ActionResult Delete(long id)
		{
			...
			{
				string msg = "";
				Bam.Net.DaoRef.DaoReferenceObject dao = Bam.Net.DaoRef.DaoReferenceObject.OneWhere(c => c.KeyColumn == id);				
				if(dao != null)
				{
					dao.Delete();	
				}
