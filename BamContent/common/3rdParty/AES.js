...
if (_ !== undefined && _ !== null) {
    var validateKeySize = function (keySize) {
        if (!(keySize == 128 || keySize == 192 || keySize == 256)) {
            throw { message: "Invalid keysize specified for AES encryption, must be : 128, 192 or 256." };
        }
    };
    var expose = {
        aes: {
            encrypt: function (plaintext, password, keySize) {
                validateKeySize(keySize);
                return AesCtr.encrypt(plaintext, password, keySize);
            },
            decrypt: function (ciphertext, password, keySize) {
                validateKeySize(keySize);
