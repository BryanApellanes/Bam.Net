...
namespace Bam.Net.Translation
{
    ...
    { 
		...
		public LanguageDetectionCollection(Database db, DataTable table, Dao dao = null, string rc = null) : base(db, table, dao, rc) { }
		public LanguageDetectionCollection(DataTable table, Dao dao = null, string rc = null) : base(table, dao, rc) { }
		public LanguageDetectionCollection(Query<LanguageDetectionColumns, LanguageDetection> q, Dao dao = null, string rc = null) : base(q, dao, rc) { }
