...
namespace Bam.Net.Translation
{
	...
	public Language LanguageOfLanguageId
	{
		...
		public static async Task BatchAll(int batchSize, Func<TranslationCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				TranslationColumns columns = new TranslationColumns();
				var orderBy = Order.By<TranslationColumns>(c => c.KeyColumn, SortOrder.Ascending);
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<TranslationCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<TranslationColumns> where, Func<TranslationCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				TranslationColumns columns = new TranslationColumns();
