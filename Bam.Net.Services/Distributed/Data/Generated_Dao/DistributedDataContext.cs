...
namespace Bam.Net.Services.Distributed.Data.Dao
{
    ...
    public static class DistributedDataContext
    {
	...
	public class CreateOperationQueryContext
	{
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.CreateOperation.Where(where, db);
			}
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.CreateOperation.Where(where, orderBy, db);
			}

			public CreateOperation OneWhere(WhereDelegate<CreateOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.CreateOperation.OneWhere(where, db);
			}

			public static CreateOperation GetOneWhere(WhereDelegate<CreateOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.CreateOperation.GetOneWhere(where, db);
			}
		
			public CreateOperation FirstOneWhere(WhereDelegate<CreateOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.CreateOperation.FirstOneWhere(where, db);
			}

			public CreateOperationCollection Top(int count, WhereDelegate<CreateOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.CreateOperation.Top(count, where, db);
			}
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.CreateOperation.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<CreateOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.CreateOperation.Count(where, db);
			}
	}
	...
	public class DataPropertyQueryContext
	{
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.DataProperty.Where(where, db);
			}
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.DataProperty.Where(where, orderBy, db);
			}

			public DataProperty OneWhere(WhereDelegate<DataPropertyColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.DataProperty.OneWhere(where, db);
			}

			public static DataProperty GetOneWhere(WhereDelegate<DataPropertyColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.DataProperty.GetOneWhere(where, db);
			}
		
			public DataProperty FirstOneWhere(WhereDelegate<DataPropertyColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.DataProperty.FirstOneWhere(where, db);
			}

			public DataPropertyCollection Top(int count, WhereDelegate<DataPropertyColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.DataProperty.Top(count, where, db);
			}
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.DataProperty.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<DataPropertyColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.DataProperty.Count(where, db);
			}
	}
	...
	public class DataPointQueryContext
	{
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.DataPoint.Where(where, db);
			}
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.DataPoint.Where(where, orderBy, db);
			}

			public DataPoint OneWhere(WhereDelegate<DataPointColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.DataPoint.OneWhere(where, db);
			}

			public static DataPoint GetOneWhere(WhereDelegate<DataPointColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.DataPoint.GetOneWhere(where, db);
			}
		
			public DataPoint FirstOneWhere(WhereDelegate<DataPointColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.DataPoint.FirstOneWhere(where, db);
			}

			public DataPointCollection Top(int count, WhereDelegate<DataPointColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.DataPoint.Top(count, where, db);
			}
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.DataPoint.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<DataPointColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.DataPoint.Count(where, db);
			}
	}
	...
	public class DataRelationshipQueryContext
	{
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.DataRelationship.Where(where, db);
			}
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.DataRelationship.Where(where, orderBy, db);
			}

			public DataRelationship OneWhere(WhereDelegate<DataRelationshipColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.DataRelationship.OneWhere(where, db);
			}

			public static DataRelationship GetOneWhere(WhereDelegate<DataRelationshipColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.DataRelationship.GetOneWhere(where, db);
			}
		
			public DataRelationship FirstOneWhere(WhereDelegate<DataRelationshipColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.DataRelationship.FirstOneWhere(where, db);
			}

			public DataRelationshipCollection Top(int count, WhereDelegate<DataRelationshipColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.DataRelationship.Top(count, where, db);
			}
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.DataRelationship.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<DataRelationshipColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.DataRelationship.Count(where, db);
			}
	}
	...
	public class DeleteEventQueryContext
	{
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.DeleteEvent.Where(where, db);
			}
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.DeleteEvent.Where(where, orderBy, db);
			}

			public DeleteEvent OneWhere(WhereDelegate<DeleteEventColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.DeleteEvent.OneWhere(where, db);
			}

			public static DeleteEvent GetOneWhere(WhereDelegate<DeleteEventColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.DeleteEvent.GetOneWhere(where, db);
			}
		
			public DeleteEvent FirstOneWhere(WhereDelegate<DeleteEventColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.DeleteEvent.FirstOneWhere(where, db);
			}

			public DeleteEventCollection Top(int count, WhereDelegate<DeleteEventColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.DeleteEvent.Top(count, where, db);
			}
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.DeleteEvent.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<DeleteEventColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.DeleteEvent.Count(where, db);
			}
	}
	...
	public class DeleteOperationQueryContext
	{
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.DeleteOperation.Where(where, db);
			}
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.DeleteOperation.Where(where, orderBy, db);
			}

			public DeleteOperation OneWhere(WhereDelegate<DeleteOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.DeleteOperation.OneWhere(where, db);
			}

			public static DeleteOperation GetOneWhere(WhereDelegate<DeleteOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.DeleteOperation.GetOneWhere(where, db);
			}
		
			public DeleteOperation FirstOneWhere(WhereDelegate<DeleteOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.DeleteOperation.FirstOneWhere(where, db);
			}

			public DeleteOperationCollection Top(int count, WhereDelegate<DeleteOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.DeleteOperation.Top(count, where, db);
			}
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.DeleteOperation.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<DeleteOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.DeleteOperation.Count(where, db);
			}
	}
	...
	public class QueryOperationQueryContext
	{
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.QueryOperation.Where(where, db);
			}
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.QueryOperation.Where(where, orderBy, db);
			}

			public QueryOperation OneWhere(WhereDelegate<QueryOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.QueryOperation.OneWhere(where, db);
			}

			public static QueryOperation GetOneWhere(WhereDelegate<QueryOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.QueryOperation.GetOneWhere(where, db);
			}
		
			public QueryOperation FirstOneWhere(WhereDelegate<QueryOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.QueryOperation.FirstOneWhere(where, db);
			}

			public QueryOperationCollection Top(int count, WhereDelegate<QueryOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.QueryOperation.Top(count, where, db);
			}
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.QueryOperation.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<QueryOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.QueryOperation.Count(where, db);
			}
	}
	...
	public class ReplicationOperationQueryContext
	{
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.ReplicationOperation.Where(where, db);
			}
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.ReplicationOperation.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<ReplicationOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.ReplicationOperation.Count(where, db);
			}
	}
	...
	public class RetrieveOperationQueryContext
	{
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.RetrieveOperation.Where(where, db);
			}
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.RetrieveOperation.Where(where, orderBy, db);
			}

			public RetrieveOperation OneWhere(WhereDelegate<RetrieveOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.RetrieveOperation.OneWhere(where, db);
			}

			public static RetrieveOperation GetOneWhere(WhereDelegate<RetrieveOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.RetrieveOperation.GetOneWhere(where, db);
			}
		
			public RetrieveOperation FirstOneWhere(WhereDelegate<RetrieveOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.RetrieveOperation.FirstOneWhere(where, db);
			}

			public RetrieveOperationCollection Top(int count, WhereDelegate<RetrieveOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.RetrieveOperation.Top(count, where, db);
			}
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.RetrieveOperation.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<RetrieveOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.RetrieveOperation.Count(where, db);
			}
	}
	...
	public class SaveOperationQueryContext
	{
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.SaveOperation.Where(where, db);
			}
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.SaveOperation.Where(where, orderBy, db);
			}

			public SaveOperation OneWhere(WhereDelegate<SaveOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.SaveOperation.OneWhere(where, db);
			}

			public static SaveOperation GetOneWhere(WhereDelegate<SaveOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.SaveOperation.GetOneWhere(where, db);
			}
		
			public SaveOperation FirstOneWhere(WhereDelegate<SaveOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.SaveOperation.FirstOneWhere(where, db);
			}

			public SaveOperationCollection Top(int count, WhereDelegate<SaveOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.SaveOperation.Top(count, where, db);
			}
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.SaveOperation.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<SaveOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.SaveOperation.Count(where, db);
			}
	}
	...
	public class UpdateOperationQueryContext
	{
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.UpdateOperation.Where(where, db);
			}
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.UpdateOperation.Where(where, orderBy, db);
			}

			public UpdateOperation OneWhere(WhereDelegate<UpdateOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.UpdateOperation.OneWhere(where, db);
			}

			public static UpdateOperation GetOneWhere(WhereDelegate<UpdateOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.UpdateOperation.GetOneWhere(where, db);
			}
		
			public UpdateOperation FirstOneWhere(WhereDelegate<UpdateOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.UpdateOperation.FirstOneWhere(where, db);
			}

			public UpdateOperationCollection Top(int count, WhereDelegate<UpdateOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.UpdateOperation.Top(count, where, db);
			}
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.UpdateOperation.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<UpdateOperationColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.UpdateOperation.Count(where, db);
			}
	}
	...
	public class WriteEventQueryContext
	{
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.WriteEvent.Where(where, db);
			}
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.WriteEvent.Where(where, orderBy, db);
			}

			public WriteEvent OneWhere(WhereDelegate<WriteEventColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.WriteEvent.OneWhere(where, db);
			}

			public static WriteEvent GetOneWhere(WhereDelegate<WriteEventColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.WriteEvent.GetOneWhere(where, db);
			}
		
			public WriteEvent FirstOneWhere(WhereDelegate<WriteEventColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.WriteEvent.FirstOneWhere(where, db);
			}

			public WriteEventCollection Top(int count, WhereDelegate<WriteEventColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.WriteEvent.Top(count, where, db);
			}
			...
			{
				return Bam.Net.Services.Distributed.Data.Dao.WriteEvent.Top(count, where, orderBy, db);
			}

			public long Count(WhereDelegate<WriteEventColumns> where, Database db = null)
			{
				return Bam.Net.Services.Distributed.Data.Dao.WriteEvent.Count(where, db);
			}
	}
