...
namespace Bam.Net.Services.Distributed.Data.Dao
{
	...
	[Serializable]
	[Bam.Net.Data.Table("DataProperty", "DistributedData")]
	...
	public CreateOperation CreateOperationOfCreateOperationId
	{
		get
		{
			...
			{
				_createOperationOfCreateOperationId = Bam.Net.Services.Distributed.Data.Dao.CreateOperation.OneWhere(c => c.KeyColumn == this.CreateOperationId, this.Database);
			}
	...
	public DeleteEvent DeleteEventOfDeleteEventId
	{
		get
		{
			...
			{
				_deleteEventOfDeleteEventId = Bam.Net.Services.Distributed.Data.Dao.DeleteEvent.OneWhere(c => c.KeyColumn == this.DeleteEventId, this.Database);
			}
	...
	public DeleteOperation DeleteOperationOfDeleteOperationId
	{
		get
		{
			...
			{
				_deleteOperationOfDeleteOperationId = Bam.Net.Services.Distributed.Data.Dao.DeleteOperation.OneWhere(c => c.KeyColumn == this.DeleteOperationId, this.Database);
			}
	...
	public QueryOperation QueryOperationOfQueryOperationId
	{
		get
		{
			...
			{
				_queryOperationOfQueryOperationId = Bam.Net.Services.Distributed.Data.Dao.QueryOperation.OneWhere(c => c.KeyColumn == this.QueryOperationId, this.Database);
			}
	...
	public SaveOperation SaveOperationOfSaveOperationId
	{
		get
		{
			...
			{
				_saveOperationOfSaveOperationId = Bam.Net.Services.Distributed.Data.Dao.SaveOperation.OneWhere(c => c.KeyColumn == this.SaveOperationId, this.Database);
			}
	...
	public UpdateOperation UpdateOperationOfUpdateOperationId
	{
		get
		{
			...
			{
				_updateOperationOfUpdateOperationId = Bam.Net.Services.Distributed.Data.Dao.UpdateOperation.OneWhere(c => c.KeyColumn == this.UpdateOperationId, this.Database);
			}
	...
	public WriteEvent WriteEventOfWriteEventId
	{
		get
		{
			...
			{
				_writeEventOfWriteEventId = Bam.Net.Services.Distributed.Data.Dao.WriteEvent.OneWhere(c => c.KeyColumn == this.WriteEventId, this.Database);
			}
		...
		public static async Task BatchQuery<ColType>(int batchSize, WhereDelegate<DataPropertyColumns> where, Action<IEnumerable<DataProperty>> batchProcessor, Bam.Net.Data.OrderBy<DataPropertyColumns> orderBy, Database database = null)
		{
			await Task.Run(async ()=>
			{
				...
				while(results.Count > 0)
				{
					...
					ColType top = results.Select(d => d.Property<ColType>(ordeBy.Column.ToString())).ToArray().Largest();
