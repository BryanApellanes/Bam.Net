...
namespace Bam.Net.Services.Distributed
{
    [Encrypt]
    [Proxy("repoSvc")]
    public class RepositoryService : ProxyableService, IDistributedRepository
    {
        protected internal RepositoryService() { }
        public RepositoryService(Repository repository, ITypeResolver typeResolver)
        {
            Repository = repository;
            TypeResolver = typeResolver;
        }

        protected internal Repository Repository { get; set; }
