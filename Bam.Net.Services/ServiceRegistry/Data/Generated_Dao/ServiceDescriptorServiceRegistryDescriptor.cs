...
namespace Bam.Net.Services.ServiceRegistry.Data.Dao
{
	...
	public ServiceDescriptor ServiceDescriptorOfServiceDescriptorId
	{
		get
		{
			...
			{
				_serviceDescriptorOfServiceDescriptorId = Bam.Net.Services.ServiceRegistry.Data.Dao.ServiceDescriptor.OneWhere(c => c.KeyColumn == this.ServiceDescriptorId, this.Database);
			}
	...
	public ServiceRegistryDescriptor ServiceRegistryDescriptorOfServiceRegistryDescriptorId
	{
		get
		{
			...
			{
				_serviceRegistryDescriptorOfServiceRegistryDescriptorId = Bam.Net.Services.ServiceRegistry.Data.Dao.ServiceRegistryDescriptor.OneWhere(c => c.KeyColumn == this.ServiceRegistryDescriptorId, this.Database);
			}
		...
		public static ServiceDescriptorServiceRegistryDescriptorCollection LoadAll(Database database = null)
		{
			...
			var results = new ServiceDescriptorServiceRegistryDescriptorCollection(sql.GetDataTable(db));
			results.Database = db;
			return results;
		}
