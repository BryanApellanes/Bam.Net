...
using Bam.Net.Services.ServiceRegistry;
...
namespace Bam.Net.Services
{
    ...
    public class ServiceRegistryService : ProxyableService
    {
        ...
        [Local]
        public CoreServices.ServiceRegistry RegisterServiceRegistryLoader(MethodInfo method, bool overwrite, string description = null)
        {
