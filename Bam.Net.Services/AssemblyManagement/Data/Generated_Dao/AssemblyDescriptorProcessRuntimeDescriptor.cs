...
namespace Bam.Net.Services.AssemblyManagement.Data.Dao
{
	...
	public ProcessRuntimeDescriptor ProcessRuntimeDescriptorOfProcessRuntimeDescriptorId
	{
		get
		{
			...
			{
				_processRuntimeDescriptorOfProcessRuntimeDescriptorId = Bam.Net.Services.AssemblyManagement.Data.Dao.ProcessRuntimeDescriptor.OneWhere(c => c.KeyColumn == this.ProcessRuntimeDescriptorId, this.Database);
			}
		...
		public static AssemblyDescriptorProcessRuntimeDescriptorCollection LoadAll(Database database = null)
		{
			...
			var results = new AssemblyDescriptorProcessRuntimeDescriptorCollection(sql.GetDataTable(db));
			results.Database = db;
			return results;
		}
