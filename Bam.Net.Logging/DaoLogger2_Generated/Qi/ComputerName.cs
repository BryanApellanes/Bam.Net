...
namespace Qi
{
    ...
    {	
		public ActionResult Save(Bam.Net.Logging.Data.ComputerName[] values)
		{
			try
			{
		...
		public ActionResult Create(Bam.Net.Logging.Data.ComputerName dao)
		{
			return Update(dao);
		}
		...
		public ActionResult Retrieve(long id)
        {
			try
			{
				object value = Bam.Net.Logging.Data.ComputerName.OneWhere(c => c.KeyColumn == id).ToJsonSafe();
		...
		public ActionResult Update(Bam.Net.Logging.Data.ComputerName dao)
        {
			try
			{
				dao.Save();
		...
		public ActionResult Delete(long id)
		{
			...
			{
				string msg = "";
				Bam.Net.Logging.Data.ComputerName dao = Bam.Net.Logging.Data.ComputerName.OneWhere(c => c.KeyColumn == id);				
				if(dao != null)
				{
					dao.Delete();	
				}
