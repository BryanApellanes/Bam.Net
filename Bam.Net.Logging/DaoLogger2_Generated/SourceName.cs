...
namespace Bam.Net.Logging.Data
{
	...
	public EventCollection EventsBySourceNameId
	{
		...
		public static async Task BatchAll(int batchSize, Func<SourceNameCollection, Task> batchProcessor, Database database = null)
		{
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<SourceNameCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<SourceNameColumns> where, Func<SourceNameCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				SourceNameColumns columns = new SourceNameColumns();
