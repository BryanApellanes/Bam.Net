...
namespace Bam.Net.Schema.Org
{
	...
	public class CreativeWork: Thing
	{
		...
		public OneOfThese<Person , Organization> Author {get; set;}
		...
		public OneOfThese<UserComments , Comment> Comment {get; set;}
		...
		public OneOfThese<Person , Organization> Contributor {get; set;}
		///<summary>The party holding the legal copyright to the CreativeWork.</summary>
		public OneOfThese<Person , Organization> CopyrightHolder {get; set;}
		...
		public OneOfThese<Person , Organization> Producer {get; set;}
		...
		public OneOfThese<Person , Organization> Translator {get; set;}
