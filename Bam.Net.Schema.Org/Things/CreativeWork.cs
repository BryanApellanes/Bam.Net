...
namespace Bam.Net.Schema.Org
{
	...
	public class CreativeWork: Thing
	{
		...
		public ThisOrThat<DateTime , Date> DateCreated {get; set;}
		...
		public ThisOrThat<DateTime , Date> DateModified {get; set;}
		...
		public ThisOrThat<Organization , Person> Producer {get; set;}
		...
		public ThisOrThat<Organization , Person> Publisher {get; set;}
		...
		public ThisOrThat<Text , URL> SchemaVersion {get; set;}
		...
		public ThisOrThat<Organization , Person> Translator {get; set;}
