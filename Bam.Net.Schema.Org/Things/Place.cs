...
namespace Bam.Net.Schema.Org
{
	...
	public class Place: Thing
	{
		...
		///<summary>The basic containment relation between a place and another that it contains. Inverse property: containsPlace.</summary>
		...
		///<summary>A URL to a map of the place. Supersedes maps, map.</summary>
		public OneOfThese<URL , Map> HasMap {get; set;}
