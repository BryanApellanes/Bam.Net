...
namespace Bam.Net.Schema.Org
{
	...
	public class Demand: Intangible
	{
		...
		public ThisOrThat<Place , GeoShape , Text> EligibleRegion {get; set;}
		...
		public ThisOrThat<Place , GeoShape , Text> IneligibleRegion {get; set;}
		...
		public ThisOrThat<Product , Service> ItemOffered {get; set;}
