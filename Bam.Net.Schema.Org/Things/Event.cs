...
namespace Bam.Net.Schema.Org
{
	...
	public class Event: Thing
	{
		...
		public ThisOrThat<Person , Organization> Attendee {get; set;}
		...
		public ThisOrThat<PostalAddress , Place> Location {get; set;}
