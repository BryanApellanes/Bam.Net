...
namespace Bam.Net.Schema.Org
{
	...
	public class Offer: Intangible
	{
		...
		public OneOfThese<Place , Text , GeoShape , AdministrativeArea> AreaServed {get; set;}
		...
		public OneOfThese<Place , Text , GeoShape> EligibleRegion {get; set;}
		...
		public OneOfThese<Place , Text , GeoShape> IneligibleRegion {get; set;}
		...
		public OneOfThese<Person , Organization> OfferedBy {get; set;}
		...
		public OneOfThese<Text , Number> Price {get; set;}
