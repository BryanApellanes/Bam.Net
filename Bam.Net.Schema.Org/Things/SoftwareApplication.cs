...
namespace Bam.Net.Schema.Org
{
	...
	public class SoftwareApplication: CreativeWork
	{
		...
		public ThisOrThat<URL , Text> ApplicationCategory {get; set;}
		///<summary>Subcategory of the application, e.g. "Arcade Game".</summary>
		public ThisOrThat<URL , Text> ApplicationSubCategory {get; set;}
		...
		public ThisOrThat<URL , Text> FeatureList {get; set;}
		...
		public ThisOrThat<URL , Text> MemoryRequirements {get; set;}
		...
		public ThisOrThat<URL , Text> ReleaseNotes {get; set;}
		...
		public ThisOrThat<URL , Text> Requirements {get; set;}
		...
		public ThisOrThat<URL , Text> StorageRequirements {get; set;}
	}
}
