...
namespace Bam.Net.Messaging.Data.Qi
{
    ...
    {	
		...
		public ActionResult Create(Bam.Net.Messaging.Data.EmailMessage dao)
		{
			return Update(dao);
		}
		...
		public ActionResult Retrieve(long id)
        {
			try
			{
				object value = Bam.Net.Messaging.Data.EmailMessage.OneWhere(c => c.KeyColumn == id).ToJsonSafe();
		...
		public ActionResult Update(Bam.Net.Messaging.Data.EmailMessage dao)
        {
			try
			{
				dao.Save();
		...
		public ActionResult Delete(long id)
		{
			...
			{
				string msg = "";
				Bam.Net.Messaging.Data.EmailMessage dao = Bam.Net.Messaging.Data.EmailMessage.OneWhere(c => c.KeyColumn == id);				
				if(dao != null)
				{
					dao.Delete();	
				}
