...
namespace Bam.Net.Analytics
{
	...
	public partial class Protocol: Dao
	{
		...
		private void SetChildren()
		{
            ...
            this.ChildCollections.Add("Url_ProtocolId", new UrlCollection(Database.GetQuery<UrlColumns, Url>((c) => c.ProtocolId == GetLongValue("Id")), this, "ProtocolId"));							
		}
	...
	public UrlCollection UrlsByProtocolId
	{
		...
		public static async Task BatchAll(int batchSize, Func<ProtocolCollection, Task> batchProcessor, Database database = null)
		{
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<ProtocolCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<ProtocolColumns> where, Func<ProtocolCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				ProtocolColumns columns = new ProtocolColumns();
