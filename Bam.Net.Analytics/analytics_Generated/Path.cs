...
namespace Bam.Net.Analytics
{
	...
	public UrlCollection UrlsByPathId
	{
		...
		public static async Task BatchAll(int batchSize, Func<PathCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				PathColumns columns = new PathColumns();
				var orderBy = Order.By<PathColumns>(c => c.KeyColumn, SortOrder.Ascending);
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<PathCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<PathColumns> where, Func<PathCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				PathColumns columns = new PathColumns();
