...
namespace Bam.Net.Analytics
{
	...
	public Category CategoryOfCategoryId
	{
		...
		public static async Task BatchAll(int batchSize, Func<FeatureCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				FeatureColumns columns = new FeatureColumns();
				var orderBy = Order.By<FeatureColumns>(c => c.KeyColumn, SortOrder.Ascending);
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<FeatureCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<FeatureColumns> where, Func<FeatureCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				FeatureColumns columns = new FeatureColumns();
