...
namespace Bam.Net.Analytics
{
	...
	public Tag TagOfTagId
	{
		...
		public static async Task BatchAll(int batchSize, Func<ImageTagCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				ImageTagColumns columns = new ImageTagColumns();
				var orderBy = Order.By<ImageTagColumns>(c => c.KeyColumn, SortOrder.Ascending);
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<ImageTagCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<ImageTagColumns> where, Func<ImageTagCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				ImageTagColumns columns = new ImageTagColumns();
