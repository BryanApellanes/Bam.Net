...
namespace Bam.Net.Analytics
{
	...
	public Timer TimerOfTimerId
	{
		...
		public static async Task BatchAll(int batchSize, Func<MethodTimerCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				MethodTimerColumns columns = new MethodTimerColumns();
				var orderBy = Order.By<MethodTimerColumns>(c => c.KeyColumn, SortOrder.Ascending);
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<MethodTimerCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<MethodTimerColumns> where, Func<MethodTimerCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				MethodTimerColumns columns = new MethodTimerColumns();
