...
namespace Bam.Net.Analytics.Qi
{
    ...
    {	
		...
		public ActionResult Create(Bam.Net.Analytics.Port dao)
		{
			return Update(dao);
		}
		...
		public ActionResult Retrieve(long id)
        {
			try
			{
				object value = Bam.Net.Analytics.Port.OneWhere(c => c.KeyColumn == id).ToJsonSafe();
		...
		public ActionResult Update(Bam.Net.Analytics.Port dao)
        {
			try
			{
				dao.Save();
		...
		public ActionResult Delete(long id)
		{
			...
			{
				string msg = "";
				Bam.Net.Analytics.Port dao = Bam.Net.Analytics.Port.OneWhere(c => c.KeyColumn == id);				
				if(dao != null)
				{
					dao.Delete();	
				}
		...
		public ActionResult OneWhere(QiQuery query)
		{
			try
			{
				query.table = Bam.Net.Data.Dao.TableName(typeof(Bam.Net.Analytics.Port));
