...
namespace Bam.Net.Analytics
{
	...
	public Tag TagOfTagId
	{
		...
		public static async Task BatchAll(int batchSize, Func<UrlTagCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				UrlTagColumns columns = new UrlTagColumns();
				var orderBy = Order.By<UrlTagColumns>(c => c.KeyColumn, SortOrder.Ascending);
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<UrlTagCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<UrlTagColumns> where, Func<UrlTagCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				UrlTagColumns columns = new UrlTagColumns();
