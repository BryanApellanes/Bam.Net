...
namespace Bam.Net.Analytics
{
	...
	public UserIdentifier UserIdentifierOfUserIdentifierId
	{
		...
		public static async Task BatchAll(int batchSize, Func<ClickCounterCollection, Task> batchProcessor, Database database = null)
		{
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<ClickCounterCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<ClickCounterColumns> where, Func<ClickCounterCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				ClickCounterColumns columns = new ClickCounterColumns();
