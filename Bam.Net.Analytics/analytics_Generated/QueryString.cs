...
namespace Bam.Net.Analytics
{
	...
	public UrlCollection UrlsByQueryStringId
	{
		...
		public static async Task BatchAll(int batchSize, Func<QueryStringCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				QueryStringColumns columns = new QueryStringColumns();
				var orderBy = Order.By<QueryStringColumns>(c => c.KeyColumn, SortOrder.Ascending);
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<QueryStringCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<QueryStringColumns> where, Func<QueryStringCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				QueryStringColumns columns = new QueryStringColumns();
