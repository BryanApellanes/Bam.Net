...
namespace Bam.Net.Analytics
{
	...
	public UrlCollection UrlsByFragmentId
	{
		...
		public static async Task BatchAll(int batchSize, Func<FragmentCollection, Task> batchProcessor, Database database = null)
		{
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<FragmentCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<FragmentColumns> where, Func<FragmentCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				FragmentColumns columns = new FragmentColumns();
