...
namespace Bam.Net.Analytics
{
	...
	public Timer TimerOfTimerId
	{
		...
		public static async Task BatchAll(int batchSize, Func<CustomTimerCollection, Task> batchProcessor, Database database = null)
		{
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<CustomTimerCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<CustomTimerColumns> where, Func<CustomTimerCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				CustomTimerColumns columns = new CustomTimerColumns();
