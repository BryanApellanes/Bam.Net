...
namespace Bam.Net.Analytics
{
	...
	public UrlCollection UrlsByPortId
	{
		...
		public static async Task BatchAll(int batchSize, Func<PortCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				PortColumns columns = new PortColumns();
				var orderBy = Order.By<PortColumns>(c => c.KeyColumn, SortOrder.Ascending);
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<PortCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<PortColumns> where, Func<PortCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				PortColumns columns = new PortColumns();
