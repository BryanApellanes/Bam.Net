...
namespace Bam.Net.ServiceProxy.Secure
{
    ...
    { 
		...
		public ConfigSettingCollection(Database db, DataTable table, Dao dao = null, string rc = null) : base(db, table, dao, rc) { }
		public ConfigSettingCollection(DataTable table, Dao dao = null, string rc = null) : base(table, dao, rc) { }
		public ConfigSettingCollection(Query<ConfigSettingColumns, ConfigSetting> q, Dao dao = null, string rc = null) : base(q, dao, rc) { }
