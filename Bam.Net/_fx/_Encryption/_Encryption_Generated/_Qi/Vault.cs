...
namespace Bam.Net.Encryption.Qi
{
    ...
    {	
		public ActionResult Save(Bam.Net.Encryption.Vault[] values)
		{
			try
			{
		...
		public ActionResult Retrieve(long id)
        {
			try
			{
				object value = Bam.Net.Encryption.Vault.OneWhere(c => c.KeyColumn == id).ToJsonSafe();
		...
		public ActionResult OneWhere(QiQuery query)
		{
			try
			{
				query.table = Bam.Net.Data.Dao.TableName(typeof(Bam.Net.Encryption.Vault));
				object value = Bam.Net.Encryption.Vault.OneWhere(query).ToJsonSafe();
				return Json(new { Success = true, Message = "", Dao = value });
			}
			catch(Exception ex)
			{
		...
		public ActionResult Where(QiQuery query)
		{
			...
			{
				query.table = Bam.Net.Data.Dao.TableName(typeof(Bam.Net.Encryption.Vault));
				object[] value = Bam.Net.Encryption.Vault.Where(query).ToJsonSafe();
				return Json(new { Success = true, Message = "", Dao = value });
			}
			catch(Exception ex)
			{
