...
namespace Bam.Net.Data.Tests
{
	...
	public CartItemCollection CartItemsByCartId
	{
		...
		public static async Task BatchAll(int batchSize, Func<CartCollection, Task> batchProcessor, Database database = null)
		{
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<CartCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<CartColumns> where, Func<CartCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				CartColumns columns = new CartColumns();
