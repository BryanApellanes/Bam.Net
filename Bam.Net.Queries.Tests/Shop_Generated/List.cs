...
namespace Bam.Net.Data.Tests
{
	...
	public ListItemCollection ListItemsByListId
	{
		...
		public static async Task BatchAll(int batchSize, Func<ListCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				ListColumns columns = new ListColumns();
				var orderBy = Order.By<ListColumns>(c => c.KeyColumn, SortOrder.Ascending);
		...
		public static async Task BatchQuery(int batchSize, QueryFilter filter, Func<ListCollection, Task> batchProcessor, Database database = null)
		{
			await BatchQuery(batchSize, (c) => filter, batchProcessor, database);			
		}

		public static async Task BatchQuery(int batchSize, WhereDelegate<ListColumns> where, Func<ListCollection, Task> batchProcessor, Database database = null)
		{
			await Task.Run(async ()=>
			{
				ListColumns columns = new ListColumns();
